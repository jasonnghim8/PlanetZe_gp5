...
public class AddItemCyclingWalkingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_add_item_cycling_walking, container, false);
    ...
    private void addItem() {
        ...
        CyclingWalkingItem item = new CyclingWalkingItem(id, Distance);
